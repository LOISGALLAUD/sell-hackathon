  ...
  return (
    <div className="p-5 bg-white xl:h-full xl:w-[40%] size-full rounded-xl overflow-hidden relative shadow-md shadow-sell-dark">
      ...
      <div className="absolute -bottom-3 left-5">
        <p className="text-xs font-medium rotate-12">Powered by AI !</p>
        <Image
          src="/images/stars.png"
          alt="Powered by AI Stars"
          width={100}
          height={100}
          className="size-12 object-contain -rotate-12"
        />
      </div>
    </div>
  );
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div2Ref} className="size-14">
            <Image
              ...
              width={100}
              height={100}
              className="size-7 text-sell-dark"
            />
          </Circle>
        </div>
